...
# MNIST inference
itwinai predict --input-dataset ./use-cases/mnist-custom/data/preproc-images \
    --predictions-location ./use-cases/mnist-custom/data/ml-predictions \
    --config ./use-cases/mnist-custom/mnist-ai-inference.yml \
    --ml-logs ./use-cases/mnist-custom/data/ml-logs
